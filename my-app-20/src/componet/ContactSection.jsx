                  ...
                  <div className="col-md-6">
                    ...
                    <div className="more-info">
                      ...
                      <ul className="list-ico">
                        <li><span className="bi bi-geo-alt"></span>bapa sitara chowk near mavdi chowk</li>
                        <li><span className="bi bi-phone"></span> (+91) 9313404257</li>
                        <li><span className="bi bi-envelope"></span> parthamipara63@gmail.com</li>
                      </ul>
                    </div>
